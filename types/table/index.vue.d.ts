type __VLS_Props = {
     ...
     */
    cellStyle?: (row: any, column: any, rowIndex: number, columnIndex: number) => Record<string, string>;
    /**
     ...
     */
    headerCellStyle?: (row: any, column: any, rowIndex: number, columnIndex: number) => Record<string, string>;
    /**
     ...
     * 合并行或列的计算方法
     */
    spanMethod?: (row: any, column: any, rowIndex: number, columnIndex: number) => {
        rowspan: number;
        colspan: number;
    };
    /**
 ...
 * 用于多选表格，切换所有行的选中状态
 */
declare function toggleAllSelection(): void;
/**
 * 用于可展开表格与树形表格，切换某一行的展开状态，如果使用了第二个参数，则是设置这一行展开与否（expanded 为 true 则展开）
 */
declare function toggleRowExpansion(row: any, expanded: boolean): void;
/**
 ...
 */
declare function clearSort(): void;
/**
 * 不传入参数时用于清空所有过滤条件，数据会恢复成未过滤的状态，也可传入由columnKey组成的数组以清除指定列的过滤条件
 */
declare function clearFilter(columnKey: string[]): void;
/**
 * 对 Table 进行重新布局。当 Table 或其祖先元素由隐藏切换为显示时，可能需要调用此方法
 */
declare function doLayout(): void;
/**
 * 手动对 Table 进行排序。参数prop属性指定排序列，order指定排序顺序。
 */
declare function sort(prop: string, order?: "ascending" | "descending"): void;
declare var __VLS_1: {};
type __VLS_Slots = {} & {
...
declare const __VLS_component: import("vue").DefineComponent<__VLS_TypePropsToOption<__VLS_Props>, {
    ...
    toggleAllSelection: typeof toggleAllSelection;
    toggleRowExpansion: typeof toggleRowExpansion;
    setCurrentRow: typeof setCurrentRow;
    clearSort: typeof clearSort;
    ...
    "sort-change": (column: any, prop: any, order: any) => void;
    "filter-change": (filters: any[]) => void;
    "current-change": (currentRow: any, oldCurrentRow: any) => void;
    "header-dragend": (newWidth: any, oldWidth: any, column: any, event: any) => void;
